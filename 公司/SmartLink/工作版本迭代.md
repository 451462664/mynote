...
(
    id                    BIGINT AUTO_INCREMENT COMMENT '主键'
        PRIMARY KEY,
    external_id           VARCHAR(20) COLLATE utf8mb4_unicode_ci DEFAULT ''                NOT NULL COMMENT '第三方id',
    ...
    CONSTRAINT faw_jf_maintain_external_id_uindex
        UNIQUE (external_id)
)
...
ALTER TABLE `smart_team`.`oil_change`
    CHANGE id id BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键自增';

ALTER TABLE `smart_team`.`oil_change`
    ADD PRIMARY KEY (id, alarm_time);

drop index IDX_id on `smart_team`.`oil_change`;

-- https://www.cnblogs.com/jkko123/p/12603721.html
-- auto-generated definition
CREATE TABLE `smart_team`.`oil_change_temp`
(
    id             BIGINT AUTO_INCREMENT COMMENT '主键自增',
    tid            VARCHAR(20)                            NOT NULL COMMENT 'tbox通讯号',
    s_oil          DOUBLE                                 NOT NULL COMMENT '起始油耗',
    e_oil          DOUBLE                                 NOT NULL COMMENT '结束油耗',
    oil_diff       DOUBLE                                 NOT NULL COMMENT '油耗差异',
    lat            DOUBLE                                 NULL COMMENT '告警纬度',
    lng            DOUBLE                                 NULL COMMENT '告警经度',
    alarm_time     DATETIME DEFAULT '0000-00-00 00:00:00' NOT NULL COMMENT '提醒时间',
    alarm_address  VARCHAR(300)                           NULL COMMENT '地址',
    message_type   INT                                    NOT NULL COMMENT '上升下降',
    creator_id     INT                                    NULL,
    create_time    DATETIME DEFAULT CURRENT_TIMESTAMP     NOT NULL,
    updater_id     INT                                    NULL,
    update_time    DATETIME DEFAULT CURRENT_TIMESTAMP     NOT NULL ON UPDATE CURRENT_TIMESTAMP,
    delete_flag    INT      DEFAULT 0                     NULL,
    alarm_end_time DATETIME                               NULL COMMENT '监测结束时间',
    PRIMARY KEY (id, alarm_time)
)
    COMMENT '油量变化历史表' CHARSET = utf8mb4;

CREATE INDEX idx_id
    ON `smart_team`.`oil_change_temp` (id);

CREATE INDEX index_tid
    ON `smart_team`.`oil_change_temp` (tid);

CREATE INDEX oil_change_alarm_time_tid_index
    ON `smart_team`.`oil_change_temp` (alarm_time);

ALTER TABLE smart_team.oil_change_temp PARTITION BY RANGE (to_days(alarm_time)) (
    PARTITION p202101 VALUES LESS THAN (to_days('2021-02-01')) ENGINE = InnoDB,
    PARTITION p202102 VALUES LESS THAN (to_days('2021-03-01')) ENGINE = InnoDB,
    PARTITION p202103 VALUES LESS THAN (to_days('2021-04-01')) ENGINE = InnoDB,
    PARTITION p202104 VALUES LESS THAN (to_days('2021-05-01')) ENGINE = InnoDB,
    PARTITION p202105 VALUES LESS THAN (to_days('2021-06-01')) ENGINE = InnoDB,
    PARTITION p202106 VALUES LESS THAN (to_days('2021-07-01')) ENGINE = InnoDB,
    PARTITION p202107 VALUES LESS THAN (to_days('2021-08-01')) ENGINE = InnoDB,
    PARTITION p202108 VALUES LESS THAN (to_days('2021-09-01')) ENGINE = InnoDB,
    PARTITION p202109 VALUES LESS THAN (to_days('2021-10-01')) ENGINE = InnoDB,
    PARTITION p202110 VALUES LESS THAN (to_days('2021-11-01')) ENGINE = InnoDB,
    PARTITION p202111 VALUES LESS THAN (to_days('2021-12-01')) ENGINE = InnoDB,
    PARTITION p202112 VALUES LESS THAN (to_days('2022-01-01')) ENGINE = InnoDB,
    ...
    PARTITION p202203 VALUES LESS THAN (to_days('2022-04-01')) ENGINE = InnoDB,
    PARTITION p202204 VALUES LESS THAN (to_days('2022-05-01')) ENGINE = InnoDB,
    PARTITION p202205 VALUES LESS THAN (to_days('2022-06-01')) ENGINE = InnoDB,
    PARTITION p202206 VALUES LESS THAN (to_days('2022-07-01')) ENGINE = InnoDB,
    PARTITION p202207 VALUES LESS THAN (to_days('2022-08-01')) ENGINE = InnoDB,
    PARTITION p202208 VALUES LESS THAN (to_days('2022-09-01')) ENGINE = InnoDB,
    PARTITION p202209 VALUES LESS THAN (to_days('2022-10-01')) ENGINE = InnoDB,
    PARTITION p202210 VALUES LESS THAN (to_days('2022-11-01')) ENGINE = InnoDB,
    PARTITION p202211 VALUES LESS THAN (to_days('2022-12-01')) ENGINE = InnoDB,
    PARTITION p202212 VALUES LESS THAN (to_days('2023-01-01')) ENGINE = InnoDB,
    ...
    PARTITION p202308 VALUES LESS THAN (to_days('2023-09-01')) ENGINE = InnoDB,
    PARTITION p202309 VALUES LESS THAN (to_days('2023-10-01')) ENGINE = InnoDB,
    PARTITION p202310 VALUES LESS THAN (to_days('2023-11-01')) ENGINE = InnoDB,
    PARTITION p202311 VALUES LESS THAN (to_days('2023-12-01')) ENGINE = InnoDB,
    PARTITION p202312 VALUES LESS THAN (to_days('2024-01-01')) ENGINE = InnoDB,
    ...
    PARTITION p202403 VALUES LESS THAN (to_days('2024-04-01')) ENGINE = InnoDB,
    PARTITION p202404 VALUES LESS THAN (to_days('2024-05-01')) ENGINE = InnoDB,
    PARTITION p202405 VALUES LESS THAN (to_days('2024-06-01')) ENGINE = InnoDB,
    PARTITION p202406 VALUES LESS THAN (to_days('2024-07-01')) ENGINE = InnoDB,
    PARTITION p202407 VALUES LESS THAN (to_days('2024-08-01')) ENGINE = InnoDB,
    PARTITION p202408 VALUES LESS THAN (to_days('2024-09-01')) ENGINE = InnoDB,
    PARTITION p202409 VALUES LESS THAN (to_days('2024-10-01')) ENGINE = InnoDB,
    PARTITION p202410 VALUES LESS THAN (to_days('2024-11-01')) ENGINE = InnoDB,
    PARTITION p202411 VALUES LESS THAN (to_days('2024-12-01')) ENGINE = InnoDB,
    PARTITION p202412 VALUES LESS THAN (to_days('2025-01-01')) ENGINE = InnoDB,
    PARTITION p202501 VALUES LESS THAN (to_days('2025-02-01')) ENGINE = InnoDB,
    PARTITION p202502 VALUES LESS THAN (to_days('2025-03-01')) ENGINE = InnoDB,
    PARTITION p202503 VALUES LESS THAN (to_days('2025-04-01')) ENGINE = InnoDB,
    PARTITION p202504 VALUES LESS THAN (to_days('2025-05-01')) ENGINE = InnoDB,
    PARTITION p202505 VALUES LESS THAN (to_days('2025-06-01')) ENGINE = InnoDB,
    PARTITION p202506 VALUES LESS THAN (to_days('2025-07-01')) ENGINE = InnoDB,
    PARTITION p202507 VALUES LESS THAN (to_days('2025-08-01')) ENGINE = InnoDB,
    PARTITION p202508 VALUES LESS THAN (to_days('2025-09-01')) ENGINE = InnoDB,
    PARTITION p202509 VALUES LESS THAN (to_days('2025-10-01')) ENGINE = InnoDB,
    PARTITION p202510 VALUES LESS THAN (to_days('2025-11-01')) ENGINE = InnoDB,
    PARTITION p202511 VALUES LESS THAN (to_days('2025-12-01')) ENGINE = InnoDB,
    PARTITION p202512 VALUES LESS THAN (to_days('2026-01-01')) ENGINE = InnoDB,
    PARTITION p_other VALUES LESS THAN (MAXVALUE)
);

INSERT INTO smart_team.oil_change_temp SELECT * FROM smart_team.oil_change;
```